...
public class HlavniOkno extends JFrame {
    ...
    private void priStisknutiTlacitka(ActionEvent e) {
        //cast alebo pretypovanie (JButton)
        JButton stisknuteTlacitko = (JButton) e.getSource();
        String puvodniCislo = editCeleCislo.getText();
        String noveCislo = puvodniCislo + stisknuteTlacitko.getText();
        editCeleCislo.setText(noveCislo);
    ...
    private void initComponents() {
        ...
        btnTlacitko7.addActionListener(e -> priStisknutiTlacitka(e));
        contentPane.add(btnTlacitko7, "cell 0 1");

        //---- btnTlacitko8 ----
        btnTlacitko8.setText("8");
        btnTlacitko8.addActionListener(e -> priStisknutiTlacitka(e));
        contentPane.add(btnTlacitko8, "cell 1 1");

        //---- btnTlacitko9 ----
        btnTlacitko9.setText("9");
        btnTlacitko9.addActionListener(e -> priStisknutiTlacitka(e));
        contentPane.add(btnTlacitko9, "cell 2 1");

        //---- btnTlacitko4 ----
        btnTlacitko4.setText("4");
        btnTlacitko4.addActionListener(e -> priStisknutiTlacitka(e));
        contentPane.add(btnTlacitko4, "cell 0 2");

        //---- btnTlacitko5 ----
        btnTlacitko5.setText("5");
        btnTlacitko5.addActionListener(e -> priStisknutiTlacitka(e));
        contentPane.add(btnTlacitko5, "cell 1 2");

        //---- btnTlacitko6 ----
        btnTlacitko6.setText("6");
        btnTlacitko6.addActionListener(e -> priStisknutiTlacitka(e));
        contentPane.add(btnTlacitko6, "cell 2 2");

        //---- btnTlacitko1 ----
        btnTlacitko1.setText("1");
        btnTlacitko1.addActionListener(e -> priStisknutiTlacitka(e));
        contentPane.add(btnTlacitko1, "cell 0 3");

        //---- btnTlacitko2 ----
        btnTlacitko2.setText("2");
        btnTlacitko2.addActionListener(e -> priStisknutiTlacitka(e));
        contentPane.add(btnTlacitko2, "cell 1 3");

        //---- btnTlacitko3 ----
        btnTlacitko3.setText("3");
        btnTlacitko3.addActionListener(e -> priStisknutiTlacitka(e));
        contentPane.add(btnTlacitko3, "cell 2 3");

        //---- btnTlacitko0 ----
        btnTlacitko0.setText("0");
        btnTlacitko0.addActionListener(e -> priStisknutiTlacitka(e));
